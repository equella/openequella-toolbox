...
public class MigrationUtilsTest {
  ...
  public void testSomeLibraryMethod() {
    try {
      ...
      String xml =
          "<xml><item version=\"1\"><rating/><badurls/><history/><moderation/><test1>qwefasdfwefasd</test1></item><metadata><keywords>these,are,keywords</keywords><keywords>these,are,other,keywords</keywords></metadata></xml>";
      assertEquals(
          "these,are,keywords",
          MigrationUtils.findFirstOccurrenceInXml(xml, "/xml/metadata/keywords/text()"));
