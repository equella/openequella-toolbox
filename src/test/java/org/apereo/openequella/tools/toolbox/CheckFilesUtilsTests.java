...
public class CheckFilesUtilsTests {
  ...
  public void testReplaceAllQuestionMark() {
    try {
      assertEquals(
          "as%XYdf",
          "as?df".replaceAll(CheckFilesUtils.specialCharReplace("QUESTION_MARK"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllPlus() {
    try {
      assertEquals(
          "as%XYdf", "as+df".replaceAll(CheckFilesUtils.specialCharReplace("PLUS"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllBlank() {
    try {
      assertEquals(
          "as%XYdf", "as df".replaceAll(CheckFilesUtils.specialCharReplace("BLANK"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllSpaceBackslash() {
    try {
      assertEquals(
          "as%XYdf",
          "as \\df".replaceAll(CheckFilesUtils.specialCharReplace("SPACE_BACKSLASH"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllBackslash() {
    try {
      assertEquals(
          "as %XYdf", "as \\df".replaceAll(CheckFilesUtils.specialCharReplace("BACKSLASH"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllForwardslash() {
    try {
      assertEquals(
          "as %XYdf",
          "as /df".replaceAll(CheckFilesUtils.specialCharReplace("FORWARDSLASH"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllOpenParen() {
    try {
      assertEquals(
          "as%XYdf", "as(df".replaceAll(CheckFilesUtils.specialCharReplace("OPEN_PAREN"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllCloseParen() {
    try {
      assertEquals(
          "as%XYdf", "as)df".replaceAll(CheckFilesUtils.specialCharReplace("CLOSE_PAREN"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllOpenBracket() {
    try {
      assertEquals(
          "as%XYdf", "as[df".replaceAll(CheckFilesUtils.specialCharReplace("OPEN_BRACKET"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllCloseBracket() {
    try {
      assertEquals(
          "as%XYdf",
          "as]df".replaceAll(CheckFilesUtils.specialCharReplace("CLOSE_BRACKET"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllOpenCurly() {
    try {
      assertEquals(
          "as%XYdf", "as{df".replaceAll(CheckFilesUtils.specialCharReplace("OPEN_CURLY"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllCloseCurly() {
    try {
      assertEquals(
          "as%XYdf", "as}df".replaceAll(CheckFilesUtils.specialCharReplace("CLOSE_CURLY"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllLeadingPeriod() {
    try {
      assertEquals(
          "%XYasd.f",
          ".asd.f".replaceAll(CheckFilesUtils.specialCharReplace("LEADING_PERIOD"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllSlashAndPeriod() {
    try {
      ...
      assertEquals(
          "as\\d.f",
          "as\\d.f".replaceAll(CheckFilesUtils.specialCharReplace("LEADING_PERIOD"), "%XY"));
      assertEquals(
          ".asd%XY.f",
          ".asd\\.f".replaceAll(CheckFilesUtils.specialCharReplace("BACKSLASH"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllPeriodsAfterBackslashes() {
    try {
      ...
      assertEquals(
          ".asd%XYf.",
          ".asd\\.f."
              .replaceAll(CheckFilesUtils.specialCharReplace("PERIOD_AFTER_BACKSLASH"), "%XY"));
      assertEquals(
          ".asd.f",
          ".asd.f".replaceAll(CheckFilesUtils.specialCharReplace("PERIOD_AFTER_BACKSLASH"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllPeriodsAfterForwardslashes() {
    try {
      ...
      assertEquals(
          ".asd%XYf.",
          ".asd/.f."
              .replaceAll(CheckFilesUtils.specialCharReplace("PERIOD_AFTER_FORWARDSLASH"), "%XY"));
      assertEquals(
          ".a/sd.f",
          ".a/sd.f"
              .replaceAll(CheckFilesUtils.specialCharReplace("PERIOD_AFTER_FORWARDSLASH"), "%XY"));
  ...
  public void testReplaceAllPipes() {
    try {
      assertEquals(
          "as%XYdf", "as|df".replaceAll(CheckFilesUtils.specialCharReplace("PIPE"), "%XY"));
      assertEquals(
          "%XYasdf", "|asdf".replaceAll(CheckFilesUtils.specialCharReplace("PIPE"), "%XY"));
      assertEquals(
          "asdf%XY", "asdf|".replaceAll(CheckFilesUtils.specialCharReplace("PIPE"), "%XY"));
  ...
  public void testReplaceAllAsterisks() {
    try {
      assertEquals(
          "as%XYdf", "as*df".replaceAll(CheckFilesUtils.specialCharReplace("ASTERISK"), "%XY"));
      assertEquals(
          "%XYasdf", "*asdf".replaceAll(CheckFilesUtils.specialCharReplace("ASTERISK"), "%XY"));
      assertEquals(
          "asdf%XY", "asdf*".replaceAll(CheckFilesUtils.specialCharReplace("ASTERISK"), "%XY"));
      assertEquals(
          "asdf", "asdf".replaceAll(CheckFilesUtils.specialCharReplace("ASTERISK"), "%XY"));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  public void testReplaceAllCarots() {
    try {
      assertEquals(
          "as%XYdf", "as^df".replaceAll(CheckFilesUtils.specialCharReplace("CARET"), "%XY"));
      assertEquals(
          "%XYasdf", "^asdf".replaceAll(CheckFilesUtils.specialCharReplace("CARET"), "%XY"));
      assertEquals(
          "asdf%XY", "asdf^".replaceAll(CheckFilesUtils.specialCharReplace("CARET"), "%XY"));
  ...
  public void testReplaceAllLeadingBackslash() {
    try {
      assertEquals(
          "as\\df",
          "as\\df".replaceAll(CheckFilesUtils.specialCharReplace("LEADING_BACKSLASH"), ""));
      assertEquals(
          "asdf", "\\asdf".replaceAll(CheckFilesUtils.specialCharReplace("LEADING_BACKSLASH"), ""));
      assertEquals(
          "asdf\\",
          "asdf\\".replaceAll(CheckFilesUtils.specialCharReplace("LEADING_BACKSLASH"), ""));
      assertEquals(
          "asdf", "asdf".replaceAll(CheckFilesUtils.specialCharReplace("LEADING_BACKSLASH"), ""));
    } catch (Exception e) {
      fail(e.getMessage());
