...
public class ConfigTest {
  ...
  public void testConfigMigrateToKalturaAttachmentSuffixesReqVideo() {
    ...
    try {
      ...
      Config.getInstance().checkMigrateToKalturaAttachmentSuffixes();
      assertFalse(
          "Config is expected to be invalid, but was valid.", Config.getInstance().isValidConfig());
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
  ...
  //						String.format(
  //										"Unable to use %s: Property [client.name] is required and was either not found or
  // empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [ping.type] is required and was either not found or
  // empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: ping.type must be 'attachments',
  // 'direct-query-all-items-all-attachments', or
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [direct.db.url] is required and was either not found or
  // empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: direct.filter.by.collection.id parsed as [five], but should be a
  // number.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: direct.filter.by.collection.id parsed as [0], but should be greater
  // than 0.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [direct.db.username] is required and was either not found
  // or empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [direct.db.password] is required and was either not found
  // or empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [direct.db.type] is required and was either not found or
  // empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [direct.filestore.dir] is required and was either not
  // found or empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Filestore Institutions directory /asdf/wef/qwef/as/Institutions
  // must exist",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Filestore Institutions 'directory'
  // ...../ping-equella/testData/misc/Institutions must be a directory",
  //										props));
  //	}
  //
  //	@Test
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [client.id] is required and was either not found or
  // empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [client.secret] is required and was either not found or
  // empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [ping.max.tries] is required and was either not found or
  // empty.",
  //										props));
  //	}
  //
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [ping.test.times.to.inject.timeout] is required and was
  ...
  //		String props =
  // "testData/props/direct-num-items-in-query-confirm-ignore-when-all-items-are-queried.properties";
  //		assertTrue(PingEquellaDriver.setup(props));
  //		assertTrue(Config.getInstance().isSetupValid());
  ...
  //		String props =
  // "testData/props/direct-num-items-in-query-missing-when-items-are-batched.properties";
  //		assertFalse(PingEquellaDriver.setup(props));
  //		assertFalse(Config.getInstance().isSetupValid());
  //		assertEquals(
  ...
  //						Config.getInstance().getSetupInvalidReason(),
  //						String.format(
  //										"Unable to use %s: Property [direct.num.items.per.query] is required and was either
  // not found or empty.",
  //										props));
  //	}
  //
  ...
  //		String props =
  // "testData/props/direct-num-items-in-query-alpha-when-items-are-batched.properties";
  //		assertFalse(PingEquellaDriver.setup(props));
  //		assertFalse(Config.getInstance().isSetupValid());
  //		assertEquals(
  ...
  //		String props =
  // "testData/props/direct-num-items-in-query-low-when-items-are-batched.properties";
  //		assertFalse(PingEquellaDriver.setup(props));
  //		assertFalse(Config.getInstance().isSetupValid());
  //		assertEquals(
  ...
  //										+
  // "testInstitutionHandleAndShortnameEqualAttsDoNotExist/Institutions/vanilla/Attachments] does
  // not exist.");
  //
  //	}
  //
  ...
  //		assertEquals(
  //						ReportManager.getInstance().getFatalErrors().get(lastIdx),
  //						"Institution [vanilla] filestore handle is different than shortname, but is not specified
  // in the properties.");
  //
  //	}
  //
  ...
  //		assertEquals(
  //						ReportManager.getInstance().getFatalErrors().get(lastIdx),
  //						"Institution [vanilla] filestore handle is different than shortname, but the handle
  // (directory) specified in the properties [swirl] does not exist.");
  //
  //	}
  //
  //	@Test
  ...
  //						ReportManager.getInstance().getFatalErrors().get(lastIdx),
  //						"Institution [vanilla] filestore attachments directory
  // [...../ping-equella/testData/filestores/testInstitutionHandleAndShortnameDiffConfigAttsDoNotExist/Institutions/swirl/Attachments] does not exist.");
  //
  //	}
}
