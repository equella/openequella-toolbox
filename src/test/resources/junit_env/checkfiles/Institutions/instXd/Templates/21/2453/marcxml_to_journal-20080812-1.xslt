...
<xsl:output method="xml"/>
	...
	<!-- ISSN 22.a, push (new array entry in meta-data element) -->
	<xsl:template match="varfield[@id = '022']">
	...
	<!-- Author(s) 100.a, 110.a + 110.b, 700.a or 710.a, push (new array entry in meta-data element)  -->
	...
	<!-- Conference Sect 111.d or 711.d, write (populate meta-data element) -->
	<!-- Conference Date 111.n or 711.n, write (populate meta-data element) -->
	<xsl:template match="varfield[@id = '111' or @id = '711']">
		<conference>
			...
			<xsl:if test="subfield[@label = 'n'] != ''">
				<xsl:for-each select="subfield[@label = 'n']">
					<year>
						<xsl:choose>
	...
	<!-- Publication place 260.a (with trailing ":", ";" or "," removed), write (populate meta-data element) -->
	...
	<xsl:template match="oai_marc">
		...
		<copyright type="Book">
			<xsl:apply-templates select="varfield[@id = '022']"/>
			<authors>
			...
			<xsl:apply-templates select="varfield[@id = '245' or @id = '246' or @id = '260']"/>
