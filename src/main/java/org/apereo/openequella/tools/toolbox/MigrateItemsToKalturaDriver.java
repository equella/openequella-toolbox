...
public class MigrateItemsToKalturaDriver {
  ...
  public void execute() throws Exception {
    ...
    //				LOGGER.info("Kaltura migration for a given item still in progress.  Waiting on further
    // work.");
    //				Thread.sleep(10000);
    //			}
    //		}
  ...
  //							}
  //							LOGGER.info("Migration stats: total # of items migrated = {}, capping # of items to
  // migrate = {}{}", totalNumOfItemsMigrated, capItemsToMigrate, cap);
  ...
  //					if(itemsToProcess != null) LOGGER.info("Cached openEQUELLA resources reviewed.  Pulling
  // next batch.");
