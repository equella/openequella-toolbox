...
public final class Check
{
     ...
     *             com.google.common.base.Objects; or 6.1 and up just use
     *             java.util.Objects which provides the same methods, but from
     *             Java 7 and up.
     */
    @Deprecated
    ...
    /**
     * Performs the standard checks, and then does a callback if necessary. See
     * the following web page for why this is like this:
